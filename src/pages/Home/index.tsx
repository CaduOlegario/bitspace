...
import { FaSort, FaPlus, FaTrash, FaPen } from "react-icons/fa"
                    ...
                    {teams.map(team => (
                        <TeamSection key={team.teamName}>
                            ...
                            <div>
                                ...
                                <div>
                                    <button onClick={() => removeTeam(team)}><FaTrash size={15} color="var(--pink)" /></button>
                                    <button onClick={() => history.push('/team', team)}><FaPen size={15} color="var(--pink)" /></button>
                                </div>
                            </div>
                        </TeamSection>
                    ))}
            ...
            <Statistics>
                ...
                <PickedPlayer>
                    <div>
                        ...
                        <main>
                            <section id="most">{mostPicked.initials}</section>
                    ...
                    <div>
                        ...
                        <main>
                            <section id="less">{lessPicked.initials}</section>
